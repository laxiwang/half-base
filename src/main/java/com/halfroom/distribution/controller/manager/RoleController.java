...
import com.halfroom.distribution.warpper.RoleWarpper;
...
import com.halfroom.distribution.persistence.model.Role;
...
public class RoleController extends BaseController {
    ...
    public String roleEdit(@PathVariable Integer roleId, Model model) {
        ...
        model.addAttribute("deptName", ConstantFactory.me().getDeptName(role.getBranchsalerid()));
    ...
    public List<ZTreeNode> roleTreeListByUserId(@PathVariable Integer userId) {
    	AdminUser theUser = this.adminUserMapper.selectById(userId);

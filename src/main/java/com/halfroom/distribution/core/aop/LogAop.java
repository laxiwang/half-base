package com.halfroom.distribution.core.aop;
...
import com.halfroom.distribution.common.constant.dictmap.factory.DictMapFactory;
...
import com.halfroom.distribution.core.support.HttpKit;
import com.halfroom.distribution.core.util.Contrast;
...
public class LogAop {
    ...
    @Pointcut(value = "@annotation(com.halfroom.distribution.common.annotion.log.BussinessLog)")

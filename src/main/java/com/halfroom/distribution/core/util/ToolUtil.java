...
public class ToolUtil {
	private static char[] takeArr = { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k',
    ...
    public static String getRandomString2(int len){
...
//	}
    ...
    public static Boolean getKaptchaOnOff() {
        return SpringContextHolder.getBean(DisProperties.class).getKaptchaOpen();
    }

...
Dept.initColumn = function () {
    return [
      ...
      /*  {title: 'id', field: 'id', align: 'center', valign: 'middle',width:'50px'},*/
        {title: '分会简称', field: 'simplename', align: 'center', valign: 'middle', sortable: true},
        {title: '分会全称', field: 'fullname', align: 'center', valign: 'middle', sortable: true},
        {title: '分会级别', field: 'levelName', align: 'center', valign: 'middle', sortable: true},
        // {title: '排序', field: 'num', align: 'center', valign: 'middle', sortable: true,visible: false},
...
Dept.delete = function () {
    if (this.check()) {
        ...
        Feng.confirm("是否刪除该分会?", operation);
    }
};
